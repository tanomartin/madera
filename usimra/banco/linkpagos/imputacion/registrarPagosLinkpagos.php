...
<?php
	...
	$sqlLeeAImputar="SELECT * FROM banextraordinariausimra WHERE  fechavalidacion != '0000-00-00 00:00:00' AND fechaimputacion = '0000-00-00 00:00:00' ORDER BY fechaarchivo, fechadeposito, idmovimiento";
