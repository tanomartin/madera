...
function irAValidar() {
	$.blockUI({ message: "<h1>Procesando la Validacion de Tickets.<br>Aguarde por favor...</h1>" });
	document.location.href = "validarTicketsLinkpagos.php";
}
...
<div align="center">
  ...
  <tr align="center" valign="top">
    <td colspan="2"><div align="center"><strong><font face="Arial, Helvetica, sans-serif">Imputaciones Link Pagos</font></strong></div></td>
  </tr>
  
  <tr align="center" valign="top">
    <td><div align="center">
		<input type="submit" name="validar" value="Validar Tickets" onclick="javascript:irAValidar()" align="left" />
</div></td>
    <td><div align="center">
