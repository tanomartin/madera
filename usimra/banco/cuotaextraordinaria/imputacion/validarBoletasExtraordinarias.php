						...
						if($resultControlBuscaValidada->fetchColumn()!=0) {
							...
							if($resultBuscaValidada) {
								foreach($resultBuscaValidada as $validada) {
									$sqlBancoValidada="SELECT * FROM banextraordinariausimra WHERE cuit = :cuit AND nrocontrol = :nrocontrol AND fechavalidacion != '00000000000000' and estadomovimiento in('P','E')";
