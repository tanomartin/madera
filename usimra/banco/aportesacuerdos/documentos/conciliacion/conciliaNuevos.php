...
//												}
	...
	?>
		...
		<td width="257" valign="middle">
		<div align="right">
        <input type="button" name="ajustar" value="Ajustar Conciliados" onclick="location.href = 'conciliacionBancaria.php'"/>
	    </div>
		</td>
		</tr>
		</table>
	...
	{ ?>
		...
		<table width="771" border="1" align="center">
		<tr align="center" valign="top">
	    <td width="771" valign="middle"><input type="reset" name="volver" value="Volver" onclick="location.href = '../documentosBancarios.php'"/>
		</td>
		</tr>
		</table>
	<?php
