...
<form id="modificaRemito" name="modificaRemito" method="post" action="guardaModificaRemito.php" onsubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      <td width="170"><div align="right">Fecha:</div></td>
      <td width="180"><input id="fecharemito" name="fecharemito" value="<?php echo invertirFecha($rowLeeRemito['fecharemito'])?>" type="text" size="10" onblur="controlaFecha()"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="180"><input id="importecomision" name="importecomision" value="<?php echo $rowLeeRemito['importecomision']?>" type="text" size="10" onblur="controlaComisionYCargaNeto()"/></td>
    </tr>
    <tr>
