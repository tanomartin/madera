...
<form id="nuevoRemito" name="nuevoRemito" method="post" action="guardaNuevoRemitoSuelto.php" onsubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      ...
      <td width="180"><input id="importecomision" name="importecomision" value="" type="text" size="10" onblur="controlaComisionYCargaFaima()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">FAIMA:</div></td>
      <td width="180"><input id="importefaima" name="importefaima" value="" type="text" size="10" onblur="controlaFaimaYCargaNeto()"/></td>
    </tr>
    <tr>
