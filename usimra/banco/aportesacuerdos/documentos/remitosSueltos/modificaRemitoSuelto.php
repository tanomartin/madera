...
function controlaComisionYCargaFaima() {
	...
	if (faima >= 0) {
		document.forms.modificaRemito.importefaima.value = faima;
	}
}

function controlaFaimaYCargaNeto() {
	var faima = new Number(document.forms.modificaRemito.importefaima.value);
	var bruto = new Number(document.forms.modificaRemito.importebruto.value);
	var comision = new Number(document.forms.modificaRemito.importecomision.value);
...
<p align="center"><strong>Modificacion de Remito Suelto</strong></p>
<form id="modificaRemito" name="modificaRemito" method="post" action="guardaModificaRemitoSuelto.php" onsubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      ...
      <td width="180"><input id="importebruto" name="importebruto" value="<?php echo $rowLeeRemito['importebruto']?>" type="text" size="10" onblur="controlaBruto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Comision:</div></td>
      <td width="180"><input id="importecomision" name="importecomision" value="<?php echo $rowLeeRemito['importecomision']?>" type="text" size="10" onblur="controlaComisionYCargaFaima()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">FAIMA:</div></td>
      <td width="180"><input id="importefaima" name="importefaima" value="<?php echo $rowLeeRemito['importefaima']?>" type="text" size="10" onblur="controlaFaimaYCargaNeto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Neto:</div></td>
      <td width="180"><input id="importeneto" name="importeneto" value="<?php echo $rowLeeRemito['importeneto']?>" type="text" size="10" readonly="readonly" onblur="controlaNeto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Cantidad de Boletas: </div></td>
      <td width="180"><input id="boletasremito" name="boletasremito" value="<?php echo $rowLeeRemito['boletasremito']?>" type="text" size="5" onblur="controlaBoletas()"/></td>
    </tr>
    <tr>
