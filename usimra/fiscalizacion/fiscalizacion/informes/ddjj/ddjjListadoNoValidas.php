...
if ($canEmpresa == 0) {
	...
	if ($canDdjjTemp == 0) {
		header ("Location: ddjjCuit.php?err=1&tipo=novalidas");
	}
}
?>
...
<body bgcolor="#B2A274">
<div align="center">
	<p><input type="button" name="volver" class="nover" value="Volver" onclick="location.href = 'ddjjCuit.php?tipo=novalidas'" /></p>
