...
function creacionArchivoCuiles($cuit, $ultano, $ultmes, $db, $tiporegistro, $nroreqArc) {
	...
	$sqlDDJJ = "SELECT anoddjj, mesddjj, cuil, sum(remuneraciones) as remuneraciones, count(cuil) as ddjjcant,
	                   if(empleadosusimra.nombre is null, concat(empleadosdebajausimra.apelli,' ',empleadosdebajausimra.nombre) , concat(empleadosusimra.apelli,' ',empleadosusimra.nombre)) as nombre
                FROM detddjjusimra
