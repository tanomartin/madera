...
<p align="center"><label>Fecha del Archivo del Banco: <input id="fechaarchivo" name="fechaarchivo" type="text" value="<?php echo date("d/m/Y",time());?>" size="10" /></label></p>
<p align="center"><label><input type="submit" name="Submit" value="Procesar" /></label></p>
</form>
</body>
</html>
