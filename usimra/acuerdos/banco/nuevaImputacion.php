...
<form id="nuevaImputacion" name="nuevaImputacion" method="POST" action="guardaNuevaImputacion.php" onSubmit="return validar(this)">
  <table width="260" border="0" align="center">
    ...
    <tr>
      ...
      <td width="130"><input id="fechaimputacion" name="fechaimputacion" value="" type="text" size="10"/></td>
    </tr>
    <tr>
      <td width="130"><div align="right">Importe Imputado: </div></td>
      <td width="130"><input id="importeimputado" name="importeimputado" value="" type="text" size="10"/></td>
    </tr>
    <tr>
      <td width="130"><div align="right">Tipo Imputacion: </div></td>
      <td width="130"><select name="selecttipoimputacion" size="1" id="selecttipoimputacion">
