...
<form id="modificaRemito" name="modificaRemito" method="POST" action="guardaModificaRemitoSuelto.php" onSubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      ...
      <td width="180"><input id="importecomision" name="importecomision" value="<?php echo $rowLeeRemito['importecomision']?>" type="text" size="10" onfocusout="controlaComisionYCargaFaima()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">FAIMA:</div></td>
      <td width="180"><input id="importefaima" name="importefaima" value="<?php echo $rowLeeRemito['importefaima']?>" type="text" size="10" onfocusout="controlaFaimaYCargaNeto()"/></td>
    </tr>
    <tr>
