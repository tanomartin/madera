...
<form id="modificaRemesa" name="modificaRemesa" method="post" action="guardaModificaRemesa.php" onsubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      ...
      <td width="180"><input id="importebruto" name="importebruto" value="<?php echo $rowLeeRemesa['importebruto']?>" type="text" size="10" onblur="controlaBruto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Comision:</div></td>
      <td width="180"><input id="importecomision" name="importecomision" value="<?php echo $rowLeeRemesa['importecomision']?>" type="text" size="10" onblur="controlaComisionYCargaFaima()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">FAIMA:</div></td>
      <td width="180"><input id="importefaima" name="importefaima" value="<?php echo $rowLeeRemesa['importefaima']?>" type="text" size="10" onblur="controlaFaimaYCargaNeto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Neto:</div></td>
      <td width="180"><input id="importeneto" name="importeneto" value="<?php echo $rowLeeRemesa['importeneto']?>" type="text" size="10" readonly="readonly" onblur="controlaNeto()"/></td>
    </tr>
    <tr>
