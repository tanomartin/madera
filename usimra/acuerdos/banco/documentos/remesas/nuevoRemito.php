...
<p align="center"><strong>Nuevo Remito</strong></p>
<form id="nuevoRemito" name="nuevoRemito" method="post" action="guardaNuevoRemito.php" onsubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      <td width="170"><div align="right">Fecha:</div></td>
      <td width="180"><input id="fecharemito" name="fecharemito" value="" type="text" size="10" onblur="controlaFecha()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Bruto:</div></td>
      <td width="180"><input id="importebruto" name="importebruto" value="" type="text" size="10" onblur="controlaBruto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Comision:</div></td>
      <td width="180"><input id="importecomision" name="importecomision" value="" type="text" size="10" onblur="controlaComisionYCargaNeto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Neto:</div></td>
      <td width="180"><input id="importeneto" name="importeneto" value="" type="text" size="10" readonly="readonly" onblur="controlaNeto()"/></td>
    </tr>
    <tr>
      <td width="170"><div align="right">Cantidad de Boletas: </div></td>
      <td width="180"><input id="boletasremito" name="boletasremito" value="" type="text" size="5" onblur="controlaBoletas()"/></td>
    </tr>
    <tr>
