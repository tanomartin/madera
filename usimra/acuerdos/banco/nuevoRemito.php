...
<form id="nuevoRemito" name="nuevoRemito" method="POST" action="guardaNuevoRemito.php" onSubmit="return validar(this)">
  <table width="500" border="1" align="center">
    ...
    <tr>
      <td width="170"><div align="right">Fecha:</div></td>
      <td width="180"><input id="fecharemito" name="fecharemito" value="" type="text" size="10" onfocusout="controlaFecha()"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="180"><input id="importecomision" name="importecomision" value="" type="text" size="10" onfocusout="controlaComisionYCargaNeto()"/></td>
    </tr>
    <tr>
