...
$noExiste = 0;
if ($nrocontrol != "") {
	$sqlBoletas = "SELECT * from boletasusimra where nrocontrol = $nrocontrol";
	...
	if ($canBoletas != 0) {
		...
		$sqlBoletasValidas = "SELECT * from validasusimra where nrocontrol = $nrocontrol";
		...
		if ($canBoletasValidas != 0) {
			...
			$sqlBoletasAnuladas = "SELECT * from anuladasusimra where nrocontrol = $nrocontrol";
