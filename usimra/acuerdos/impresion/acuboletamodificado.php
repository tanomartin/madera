...
//Ejecucion del sql para incrementar la cantidad de boletas impresas en tabla cuoacuerdosospim
	...
	<p><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="impBoletas.php?cuit=<?php echo $cuit ?>&acuerdo=<?php echo $acuerdo ?>">VOLVER</a></strong></font></p>
</body>
</html>