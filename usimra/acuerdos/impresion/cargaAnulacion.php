...
<div align="center">
  	...
  	<h3>Módulo Anulación de Bolestas Impresas</h3>
<?php if (isset($_GET['err'])) {
  		$err = $_GET['err'];
		if ($err == 1) { ?>
			  <p><b style='color:red'>BOLETA NO ENCONTRADA </b></p>
<?php	}
		if ($err == 2) { 
			$control = $_GET['control']; ?>
			  <p><b style='color:blue'>SE ANULO LA BOLETA CON CODIGO DE IDENTIFICACION "<?php echo $control ?>"</b></p>
<?php	}
  	} ?>
	<form id="anulacion" name="anulacion" method="post" onsubmit="return validar(this)" action="validarAnulacion.php">
		<p><b>Codigo de identificacion de boleta</b></p>
	    <p><input name="nroControl" id="nroControl" type="text" size="12" style="text-align:center"/></p>
		<p><b>¿Documentacion en Mano?</b></p>
		<p>
			<input name="docuMano" id="docuMano" type="radio" value="1" /> SI
			<input name="docuMano" id="docuMano" type="radio" value="2" /> NO		 
		</p>
	    <p><b>¿Fue al Banco?</b></p>
	    <p>
