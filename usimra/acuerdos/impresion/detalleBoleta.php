...
$estado = $_GET['estado'];
if ($estado == "Generada") { $sqlBoleta = "SELECT * from boletasusimra where nrocontrol = $nrocontrol"; }
if ($estado == "Validada") { $sqlBoleta = "SELECT * from validasusimra where nrocontrol = $nrocontrol"; }
if ($estado == "Anulada") { $sqlBoleta = "SELECT * from anuladasusimra where nrocontrol = $nrocontrol"; }
