...
if(strcmp("localhost",$maquina)==0)
	...
	$archivo_name="/home/sistemas/Documentos/Repositorio/GGGG1210121610SYS/MontosDiferentesAl-".substr($fechagenera, 0, 2)."-".substr($fechagenera, 3, 2)."-".substr($fechagenera, 6, 4)." (".$hora.").xls";
...
try{
	...
	$sqlAcuerdos="SELECT
					...
					FROM cabacuerdosusimra c, cabacuerdosusimra d
					where
					c.cuit = d.cuit and
