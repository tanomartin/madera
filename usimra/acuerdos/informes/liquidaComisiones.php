...
<body bgcolor="#B2A274">
<form id="form1" name="form1" onSubmit="return validar(this)" method="post" action="liquidaComisionesExcel.php" enctype="multipart/form-data" >
<div align="center">
...
<p align="center" class="Estilo1">Liquidaciones</p>
