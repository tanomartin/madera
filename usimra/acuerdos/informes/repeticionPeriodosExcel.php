...
if(strcmp("localhost",$maquina)==0)
	...
	$archivo_name="/home/sistemas/Documentos/Repositorio/GGGG1210121610SYS/PeriodosRepetidosAl-".substr($fechagenera, 0, 2)."-".substr($fechagenera, 3, 2)."-".substr($fechagenera, 6, 4)." (".$hora.").xls";
...
try{
	...
	$sqlAcuerdos="SELECT c.cuit, d.nroacuerdo as acu1, d1.nroacuerdo as acu2 FROM detacuerdosusimra d, detacuerdosusimra d1, cabacuerdosusimra c
