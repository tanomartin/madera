...
if(strcmp("localhost",$maquina)==0)
	...
	$archivo_name="/home/sistemas/Documentos/Repositorio/GGGG1210121610SYS/Existencia de Caja al ".substr($fechacargada, 0, 2)."-".substr($fechacargada, 3, 2)."-".substr($fechacargada, 6, 4).".xls";
...
try{
	...
	$objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&BU.S.I.M.R.A.&G&C&H&BExistencia de Caja al '.$objPHPExcel->getActiveSheet()->getTitle().'&R&B'.$fechagenera);
	...
	$sqlCuotas="SELECT * FROM cuoacuerdosusimra WHERE tipocancelacion = 2 and (sistemacancelacion = '' || fechacancelacion > '$fechafin') and fecharegistro <= '$fechafin' order by cuit, nroacuerdo, nrocuota";
