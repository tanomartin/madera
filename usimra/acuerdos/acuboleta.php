...
print ("  </tr>");
print ("  <tr>");
print ("    <td width=70 align=center colspan=2><font face=Arial Narrow size=1>".$rowRedun['nroact']."-".$rowRedun['nroacu']."</font></td>");
print ("    <td width=69 align=center colspan=2><font face=Arial Narrow size=1>".$rowRedun['nrocuo']."</font></td>");
...
print ("    <td width=69 align=center><font face=Arial Narrow size=1> --- </font></td>");
print ("    <td width=69 align=center><font face=Arial Narrow size=1> --- </font></td>");
print ("    <td width=76 align=center><font face=Arial Narrow size=1><b>".number_format($rowRedun['importe'], 2, ",", ".")."</b></font></td>");
print ("  </tr>");
print ("  <tr>");
...
$nconvenio = 3617;
$ncuasifinal = $nconvenio.$nrcuit.$rowRedun['fecpro'];
print ("<br>");
print ("<br>");
...
if($_SESSION['aut'] > 1) {
?>
<p><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="acuerdos2Fisca.php?nrcuit=<?php echo $nrcuit ?>&delcod=<?php echo $delcod ?>&empcod=<?php echo $empcod ?>">VOLVER</a></strong></font></p>
<?php
} else {
?>
<p><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="acuerdos2.php?nrcuit=<?php echo $nrcuit ?>&delcod=<?php echo $delcod ?>&empcod=<?php echo $empcod ?>">VOLVER</a></strong></font></p>
<?php } ?>
</body>
