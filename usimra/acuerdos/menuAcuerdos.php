  ...
  <table width="614" border="3">
    ...
    <tr>
	  ...
	  <!-- href="informes/moduloInformes.php" -->
        <p align="center"><a href="<?php echo $_SERVER['DOCUMENT_ROOT']?>/usimra/moduloNoDisponible.php"><img src="img/informes.jpg" width="120" height="80" border="0" alt="enviar"/></a></p>
      <p>&nbsp;</p></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td><p align="center">Fiscalizaci&oacute;n</p>
        ...
        <p align="center"><a class="enlace" href="<?php echo $_SERVER['DOCUMENT_ROOT']?>/usimra/moduloNoDisponible.php"><img src="img/fiscalizacion.jpg" width="97" height="76" border="0" alt="enviar"/></a></p>
        <p align="center">&nbsp;</p></td>
      <td><p align="center">Valores al Cobro</p>
	   <!-- href="valores/moduloValores.php" -->
      <p align="center"><a class="enlace" href="<?php echo $_SERVER['DOCUMENT_ROOT']?>/usimra/moduloNoDisponible.php"><img src="img/valores.jpg" width="96" height="76" border="0" /></a></p>
      <p align="center">&nbsp;</p></td>
    </tr>
  </table>
  <p>&nbsp;</p>
