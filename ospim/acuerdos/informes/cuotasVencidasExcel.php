...
if(strcmp("localhost",$maquina)==0)
	...
	$archivo_name="/home/sistemas/Documentos/Repositorio/FFFF1208311301SYS/Ctas Vdas Sin Cancelar Hasta el ".substr($fechacargada, 0, 2)."-".substr($fechacargada, 3, 2)."-".substr($fechacargada, 6, 4).".xls";
...
try{
	...
	$objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&BO.S.P.I.M.&G&C&H&BCuotas Vencidas sin Cancelar hasta el '.$objPHPExcel->getActiveSheet()->getTitle().'&R&B'.$fechagenera);
	...
	$sqlCuotas="SELECT * FROM cuoacuerdosospim WHERE fechacuota <= $fechabusca AND tipocancelacion >= 1 AND tipocancelacion <= 3 order by cuit, nroacuerdo, nrocuota";
