...
//Ejecucion del sql para incrementar la cantidad de boletas impresas en tabla cuoacuerdosospim
	...
	$posiniima=69;
	$pdf->Image('jpg/x.jpg',$posiniima,84,2.6,7);
	for ($i=0; $i < 29; $i++) {
		$poscuit = "jpg/".substr($ncuasifinal,$i,1).".jpg";
		$posiniima=$posiniima+2.6;
		$pdf->Image($poscuit,$posiniima,84,2.6,7);
	}
	$pdf->Image('jpg/tijera.jpg',30,101,6.5,4);
	
	$nombrearchivo = "H:\\Boletas\\".$nrcuit.$nroact.$nroacu.$nrocuo.".pdf";
