...
<title>.: Listado De Familiares SSS por Delegacion :.</title>
...
<body bgcolor="#CCCCCC">
<div align="center">
  	<input type="reset" name="volver" value="Volver" class="nover" onclick="location.href = '../menuDescInfoFamiSSS.php'" />
	<form name="titularesSSSAlta" id="titularesSSSAlta" method="post" onsubmit="return validar(this)" action="altaFamiliaresSSS.php">
  	<h2>Descarga Familiares SSS por Delegaci&oacute;n </h2>
	<table>
		<tr>
		  	<td>
				<div align="left">
