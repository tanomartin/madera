...
<div align="center">
  <p><input type="button" name="volver" value="Volver" onclick="location.href = 'moduloInformes.php'" /></p>
	...
	<form  name="selectDelegacion" id="selectDelegacion" method="post" onsubmit="return validar(this)" action="titularesfuturaaltasssexcel.php">
  	<h3>Listado de Futuras Alta SSS por Delegaci&oacute;n </h3>
  	...
  	<?php if (isset($_GET['error'])) { 
			...
			if ($_GET['error'] == 2) {
				$nomdelega = $_GET['delega'];
				print("<p><font color='#0000FF'><b> No existen titulares para dar de alta desde la SSS para la delegación $nomdelega.</b></font></p>");
			}
  	 } ?>
	<table>
		<tr>
