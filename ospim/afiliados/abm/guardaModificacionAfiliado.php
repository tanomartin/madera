...
$discapacidad = $datos[21];
//echo $datos[22]; echo "<br>"; //certificadodiscapacidad
$certificadodiscapacidad = $datos[22];
//echo $datos[23]; echo "<br>"; //cuil
$cuil = $datos[23];
//echo $datos[24]; echo "<br>"; //cuitempresa
$cuitempresa = $datos[24];
//echo $datos[25]; echo "<br>"; //nombreempresa (no guarda)
//echo $datos[26]; echo "<br>"; //fechaempresa
$fechaempresa = fechaParaGuardar($datos[26]);
//echo $datos[27]; echo "<br>"; //codidelega
$codidelega = $datos[27];
//echo $datos[28]; echo "<br>"; //categoria
$categoria = strtoupper($datos[28]);
//echo $datos[29]; echo "<br>"; //emitecarnet
$emitecarnet = $datos[29];
//echo $datos[30]; echo "<br>"; //cantidadcarnet (no guarda)
//echo $datos[31]; echo "<br>"; //fechacarnet (no guarda)
//echo $datos[32]; echo "<br>"; //tipocarnet (no guarda)
