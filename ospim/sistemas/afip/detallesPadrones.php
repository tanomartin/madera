...
$ctamensaje='afippadron@ospim.com.ar';
...
if($canBuscaMensaje!=0) {
	...
	if(strcmp($rowBuscaMensaje['tipoarchivo'],"PADJ")==0) {
		$tituloform = 'Resultados de Procesamiento Padrones por DDJJ - Archivo Nro: '.$nrodisco;
		$sqlBuscaArchivo = "SELECT * FROM padronesddjj WHERE nrodisco = '$nrodisco'";
