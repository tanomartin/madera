...
<script type="text/javascript">
	$(function() {
		$("#listamsj")
		.tablesorter({widthFixed: true, widgets:['zebra'], headers:{3:{sorter:false}, 5:{sorter:false}}})
...
<?php if ($total_emails != 0) {?>
	...
	<?php foreach ($result as $overview) {
		...
		<?php } else { ?>
				<td><input type="button" value="Archivo Procesado" onClick="window.location.href='detallesTransferencias.php?fechaMens=<?php echo $fechaMens;?>&nroMail=<?php echo $nroMail;?>'"></td>
		<?php } ?>
			</tr>
	<?php }?>
		</tbody>
