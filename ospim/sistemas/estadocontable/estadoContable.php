...
<body bgcolor="#CCCCCC">
<form id="form1" name="form1" onsubmit="return validar(this)" method="post" action="generarEstadoContable.php" >
<div align="center">
	<input type="button" name="volver" value="Volver" onclick="location.href = '../menuSistemas.php'" /> 
</div>
<p align="center" class="Estilo1">Estado Contable</p>
<?php   if (isset($_GET['ok'])) { 
			if ($_GET['ok'] == 1) {?>
			<p align="center" style="color: blue;"><b>Informe Generado</b></p> 
<?php   	} else { ?>
			<p align="center" style="color: red;"><b>Informe Generado con Anterioridad</b></p> 
<?php		}
		} ?>
