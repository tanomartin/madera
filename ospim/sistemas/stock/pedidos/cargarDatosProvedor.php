...
<div align="center">
  ...
  <table class="tablesorter" id="listado" style="width:800px; font-size:14px; text-align: center">
    ...
    <tr>
		...
		<th><input name="total" id="total" type="text" size="10" value="<?php echo  $total ?>" readonly="readonly" style="background-color:#CCCCCC" /></th>
		<th></th>
	</tr>
  </table>
  <p><input class="nover" type="submit" name="Submit" value="Guardar Cambios"/></p>
