...
<div align="center">
  ...
  <p><span class="Estilo2">Listado de Productos </span></p>
  ...
  <table class="tablesorter" id="listado" style="width:800px; font-size:14px">
	 ...
	 <tbody>
		<?php	
			$sqlProd = "SELECT p.*, i.idProducto, d.nombre as deptos FROM ubicacionproducto u, departamentos d, producto p LEFT JOIN insumos i ON p.id=i.idProducto WHERE u.id = p.id and u.departamento = d.id";
			...
			<tr align="center">
					...
					<td><a href='modificarProducto.php?id=<?php echo $rowProd['id'] ?>'>Modificar</a> 
					<?php if ($rowProd['idProducto'] != "") { ?>
						- <a href='insumos.php?id=<?php echo $rowProd['id'] ?>'>Insumos</a></td>
					<?php } ?>
