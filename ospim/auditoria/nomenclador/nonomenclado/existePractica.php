...
<div align="center">
  ...
  <p><span class="Estilo2" style="color:#FF0000">La practica de codigo <b><?php echo $codigo ?></b> ya existe con la misma descripción</span></p>
  <p><span class="Estilo2"><?php echo $codigo." - ".$rowPractica['descripcion'] ?></span></p>
</div>
</body>
</html>
