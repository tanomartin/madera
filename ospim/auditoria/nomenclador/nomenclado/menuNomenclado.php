  ...
  <form id="menunomen" name="menunomen">
	  ...
	  <table width="400" border="3" style="text-align: center">
	    <tr>
		  ...
		  <td width="200">
		  	<p>ABM VALORES Y PROPIEDADES </p>
	        <p><a href="#"><img src="img/propiedades.png" width="90" height="90" border="0" alt="enviar" onclick="redireccion('cargarPropiedadesNomenclado.php')"/></a></p>
	      </td>
	    </tr>
	  </table>
  </form>
