...
if(isset($_POST)) {
	...
	try {
		...
		$sqlAgregaInsumos = "INSERT INTO diabetesinsumos (idDiagnostico,
tirasreactivas,
tirasreactivaspresentacion,
tirasreactivasdosis,
tirasreactivasinicio,
lancetas,
lancetaspresentacion,
lancetasdosis,
lancetasinicio,
agujas,
agujaspresentacion,
...
:fechamodificacion,
:usuariomodificacion)";
		$resAgregaInsumos = $dbh->prepare($sqlAgregaInsumos);
		if($resAgregaInsumos->execute(array(':idDiagnostico' => $_POST['iddiagnostico'],
