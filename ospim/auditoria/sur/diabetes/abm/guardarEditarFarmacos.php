...
if(isset($_POST)) {
	...
	try {
		...
		$sqlActualizaFarmacos = "UPDATE diabetesfarmacos SET 
...
WHERE idDiagnostico = :idDiagnostico";
		$resActualizaFarmacos = $dbh->prepare($sqlActualizaFarmacos);
		if($resActualizaFarmacos->execute(array(':idDiagnostico' => $_POST['iddiagnostico'],
':metformina' => $metformina,
':metforminapresentacion' => $metforminapresentacion,
':metforminadosis' => $metforminadosis,
':metforminainicio' => $metforminainicio,
