...
<title>.: M&oacute;dulo Resoluciones :.</title>

</head>
<body bgcolor="#CCCCCC">
<div align="center">
  <p><input type="button" name="volver" value="Volver" onclick="location.href = '../moduloDisca.php'"/></p>
  <h3>Men&uacute; Resoluciones</h3>
  <table width="400" border="3" style="text-align: center">
    <tr>
      	<td width="200">
      		<p>RESOLUCIONES </p>
          	<p><a class="enlace" href="resoluciones.php"><img src="img/resoluciones.png" width="90" height="90" border="0" alt="enviar"/></a></p>
        </td>
      	<td width="200">
      		<p>BUSCADOR</p>
