...
<body bgcolor="#CCCCCC">
	...
	<div align="center">
		<table id="beneficiarios" class="tablesorter" style="font-size:14px; text-align:center">
			...
			<tbody>
		<?php
		$sqlTitularActivo = "SELECT p.nroafiliado, t.apellidoynombre, t.nrodocumento, t.cuil FROM hivbeneficiarios p, titulares t WHERE p.nroorden = 0 AND p.nroafiliado = t.nroafiliado ORDER BY p.nroafiliado";
		...
		$sqlTitularInactivo = "SELECT p.nroafiliado, t.apellidoynombre, t.nrodocumento, t.cuil, t.fechabaja FROM hivbeneficiarios p, titularesdebaja t WHERE p.nroorden = 0 AND p.nroafiliado = t.nroafiliado ORDER BY p.nroafiliado";
		...
		$sqlFamiliarActivo = "SELECT p.nroafiliado, p.nroorden, k.descrip, f.apellidoynombre, f.nrodocumento, f.cuil FROM hivbeneficiarios p, familiares f, parentesco k WHERE p.nroorden != 0 AND p.nroafiliado = f.nroafiliado AND p.nroorden = f.nroorden AND f.tipoparentesco = k.codparent ORDER BY p.nroafiliado, p.nroorden";
		...
		$sqlFamiliarInactivo = "SELECT p.nroafiliado, p.nroorden, k.descrip, f.apellidoynombre, f.nrodocumento, f.cuil, f.fechabaja FROM hivbeneficiarios p, familiaresdebaja f, parentesco k WHERE p.nroorden != 0 AND p.nroafiliado = f.nroafiliado AND p.nroorden = f.nroorden AND f.tipoparentesco = k.codparent ORDER BY p.nroafiliado, p.nroorden";
	...
	<form id="moduloHiv" name="moduloHiv" method="post"  onsubmit="return validar(this)" action="buscaBeneficiario.php">
		<div align="center">
			<h2>Nuevo Ingreso</h2>
		</div>
		<div align="center">
	...
	<?php 
		...
		if ($err == 4) {
			print("<div align='center' style='color:#FF0000'><b> EL BENEFICIARIO QUE INTENTA AGREGAR YA EXISTE EN LA LISTA DE HIV </b></div>");
		}
	?>
	</div>
