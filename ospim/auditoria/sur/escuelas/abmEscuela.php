...
<body bgcolor="#CCCCCC">
<div align="center">
	<form id="moduloEscuelas" name="moduloEscuelas" method="post" onsubmit="return validar(this)" action="abmEscuela.php">
		<p><input class="nover" type="reset" name="volver" value="Volver" onclick="location.href = 'moduloEscuelas.php'" /></p>
