...
<table width="1100" border="0">
  ...
  <tr>
    <td valign="top"><p><strong>Tipo:</strong> <?php if($rowLeeSolicitud['practica']==1) echo "Practica"; else { if($rowLeeSolicitud['material']==1) echo "Material - ".$rowLeeMaterial['descripcion']; else { if($rowLeeSolicitud['medicamento']==1) echo "Medicamento";}} ?></p>
      ...
      <p><?php if($rowLeeSolicitud['presupuesto1']!=NULL) { print "<a href='mostrarArchivo.php?nroSolicitud=".$rowLeeSolicitud['nrosolicitud']."&archivo=4' target='_blank'> Ver </a>";} ?></p>
      <p><?php if($rowLeeSolicitud['presupuesto2']!=NULL) { print "<a href='mostrarArchivo.php?nroSolicitud=".$rowLeeSolicitud['nrosolicitud']."&archivo=5' target='_blank'> Ver </a>";} ?></p>
      <p><?php if($rowLeeSolicitud['presupuesto3']!=NULL) { print "<a href='mostrarArchivo.php?nroSolicitud=".$rowLeeSolicitud['nrosolicitud']."&archivo=6' target='_blank'> Ver </a>";} ?></p>
      <p><?php if($rowLeeSolicitud['presupuesto4']!=NULL) { print "<a href='mostrarArchivo.php?nroSolicitud=".$rowLeeSolicitud['nrosolicitud']."&archivo=7' target='_blank'> Ver </a>";} ?></p>
      <p><?php if($rowLeeSolicitud['presupuesto5']!=NULL) { print "<a href='mostrarArchivo.php?nroSolicitud=".$rowLeeSolicitud['nrosolicitud']."&archivo=8' target='_blank'> Ver </a>";} ?></p>    </td>
	<td valign="top">
