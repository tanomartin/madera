...
function cargaConsumo(idfactura, idfacturabeneficiario) {
	...
	window.location.href="consumoMedicamento.php?"+param;
};

function eliminaBeneficiario(idfactura, idfacturabeneficiario) {
	param = "idFactura="+idfactura+"&idFacturabeneficiario="+idfacturabeneficiario+"&origenAnulacion=M";
...
function anulaCarencia(idcarencia, idfactura) {
	param = "idCarencia="+idcarencia+"&idFactura="+idfactura+"&origenAnulacion=M";
		...
		<?php while($rowConsultaFacturasBeneficiarios = mysql_fetch_array($resConsultaFacturasBeneficiarios)) {
			...
			<tr>
				...
				<?php
					...
					?>
					<input name="<?php echo $botonconsumo;?>" type="button" id="<?php echo $botonconsumo;?>" value="Consumo Medicamento" style="font-size:10px" onclick="javascript:cargaConsumo(<?php echo $idcomprobante;?>,<?php echo $rowConsultaFacturasBeneficiarios['id'];?>)"/>
				<?php
					} else {
				...
				<?php
					...
					<input name="<?php echo $botonconsumo;?>" type="button" id="<?php echo $botonconsumo;?>" value="Consumo Medicamento" style="font-size:10px" disabled="disabled" onclick="javascript:cargaConsumo(<?php echo $idcomprobante;?>,<?php echo $rowConsultaFacturasBeneficiarios['id'];?>)"/>
					<input name="<?php echo $botonanulacion;?>" type="button" id="<?php echo $botonanulacion;?>" value="Anular Beneficiario" style="font-size:10px" onclick="javascript:eliminaBeneficiario(<?php echo $idcomprobante;?>,<?php echo $rowConsultaFacturasBeneficiarios['id'];?>)"/>
				<?php
						}
					} ?>
