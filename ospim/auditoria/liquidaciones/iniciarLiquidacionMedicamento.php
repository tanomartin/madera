...
<script type="text/javascript">
	function enviaFormulario() {
		...
		document.getElementById("iniciarLiquidacionMedicamento").submit();
	}
</script>
</head>
<body onLoad="enviaFormulario();">
<form id="iniciarLiquidacionMedicamento" name="iniciarLiquidacionMedicamento" method="post" action="continuarLiquidacionMedicamento.php"> 
