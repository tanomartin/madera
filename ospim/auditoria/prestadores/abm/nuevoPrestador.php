...
function validar(formulario) {
	...
	if (formulario.nroRegistro.value != "") {
		if (!esEnteroPositivo(formulario.nroRegistro.value)) {
  ...
  <form name="nuevoPrestador" id="nuevoPrestador" method="post" onSubmit="return validar(this)" action="guardarNuevoPrestador.php">
    <table width="800" border="0">
      ...
      <tr>
        ...
        <td colspan="2"><div align="left">
            (<input name="ddn1" type="text" id="ddn1" size="5" />)-<input name="telefono1" type="text" id="telefono1" size="20" />
</div></td>
      </tr>
      <tr>
        <td><div align="right"><strong>Telefono 2 </strong></div></td>
        <td colspan="2"><div align="left">
          (<input name="ddn2" type="text" id="ddn2" size="5"/>)-<input name="telefono2" type="text" id="telefono2" size="20"/>
        </div></td>
      </tr>
      <tr>
        <td><div align="right"><strong>Telefono FAX </strong></div></td>
        <td colspan="2"><div align="left">
          (<input name="ddnfax" type="text" id="ddnfax" size="5"/>)-<input name="telefonofax" type="text" id="telefonofax" size="20" />
        </div></td>
      </tr>
	  <tr>
	  ...
	  <tr>
	    <td height="43" colspan="3"><div align="center" class="Estilo1"><strong>Servicios </strong></div></td>
      </tr>
	  <tr>
        <td><div align="right"><strong>Tipos de Servicios </strong></div></td>
	    <td colspan="2"><div align="left">
		<?php 
				$query="select * from tiposervicio";
				$result=mysql_query($query,$db);
				while ($rowtipos=mysql_fetch_array($result)) { ?>
					 <input type="checkbox" id="<?php echo "servicio".$rowtipos['codigoservicio'] ?>" name="<?php echo "servicio".$rowtipos['codigoservicio'] ?>" value="<?php echo $rowtipos['codigoservicio'] ?>" disabled="disabled"><?php echo $rowtipos['descripcion'] ?><br>
		  <?php } ?></div></td>
      </tr>
	  <tr>
	    <td height="42" colspan="3"><div align="center" class="Estilo1"><strong>Jurisdiccion </strong></div></td>
      </tr>
	  <tr>
        <td><div align="right"><strong>Delegaciones </strong></div></td>
