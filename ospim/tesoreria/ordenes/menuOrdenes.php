	...
	<h2>Menú Ordenes de Pago </h2>
  	<table width="600" border="1" style="text-align: center">
    	<tr>
	  		<td width="200">
	  			<p>ORDENES DE PAGO</p>
          		<p><a href="../../moduloNoDisponible.php.php"><img src="img/ordenespago.png" width="90" height="90" border="0"/></a></p>
      		</td>
      		<td width="200">
	  			<p>ORDENES NO MEDICA</p>
          		<p><a href="../../moduloNoDisponible.php"><img src="img/ordenespagonm.png" width="90" height="90" border="0"/></a></p>
      		</td>
      		<td width="200">
