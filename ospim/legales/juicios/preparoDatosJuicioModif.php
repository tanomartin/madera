...
<form action="guardarModificarJuicio.php" id="datosJuicio" method="post" style="visibility:hidden"> 
    <p>
      <input name="cuit" size='200' type="text" value="<?php echo $cuit ?>"/>
  </p>
    <p>  
      <input name="nroorden" size='200' type="text" value="<?php echo $nroorden ?>"/>
  </p>
    <p>
      <input name="insertPerAcuQuitado" size='200' type="text" value="<?php echo $listadoPeriodosAcuQuitadoSerializado ?>"/>
  </p>
    <p>
      <input name="updateCabeceraAcuQuitado" size='200' type="text" value="<?php echo $sqlUpdateAcuQuitado ?>"/>
  </p>
    <p>
      <input name="deletePeriodos" size='200' type="text" value="<?php echo $sqlDeletePeriodos ?>"/>
  </p>
    <p>
      <input name="updateCabeceraAcuAbs" size='200' type="text" value="<?php echo $sqlUpdateAcuAbs ?>"/>
  </p>
    <p>
      <input name="updateCabeceraJui" size='200' type="text" value="<?php echo $sqlCabecera ?>"/>
  </p>
    <p>
      <input name="insertPeriodosJui" size='200' type="text" value="<?php echo $listadoPeriodosJuiSerializado ?>"/>
  </p>
    <p>
      <input name="deletePeriodosAcuAbs" size='200' type="text" value="<?php echo $listadoPeriodosAcuAbsSerializado ?>"/> 
     </p>
</form> 
</body>
</html>