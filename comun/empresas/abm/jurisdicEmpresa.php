    ...
    <table width="53%" height="261" border="2">
      ...
      <tr bordercolor="#000000" >
        ...
        <td width="33%"><p align="center">
          <?php if ($canjuris > 1) { ?>
          <input name="Input" type="button" value="Eliminar Jurisdiccion" onclick="location.href='eliminarJurisdiccion.php?origen=<?php echo $origen ?>&amp;cuit=<?php echo $cuit ?>&amp;coddel=<?php echo $delega ?> '"/>
          <?php } ?>
          </p>
        </td>
      </tr>
